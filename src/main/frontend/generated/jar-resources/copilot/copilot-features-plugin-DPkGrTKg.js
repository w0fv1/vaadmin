import { w as p, Q as c, U as g, m as f } from "./copilot-ZFCmeq8A.js";
import { r as u } from "./state-BHWeUk7p.js";
import { B as h } from "./base-panel-BzuRx725.js";
import { showNotification as m } from "./copilot-notification-uGUDnAiD.js";
import { i as v } from "./icons-BwFDlvNs.js";
...
var w = Object.defineProperty, F = Object.getOwnPropertyDescriptor, d = (e, t, a, o) => {
  for (var s = o > 1 ? void 0 : o ? F(t, a) : t, r = e.length - 1, l; r >= 0; r--)
    (l = e[r]) && (s = (o ? l(t, a, s) : l(s)) || s);
  return o && s && w(t, a, s), s;
};
