...
var Cr = Object.assign, $t = Object.getOwnPropertyDescriptor, Z = Object.defineProperty, zt = Object.prototype, Ct = [];
Object.freeze(Ct);
var Nn = {};
Object.freeze(Nn);
...
var at = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : jr ? function(e) {
...
function Lr(e, t, n) {
  ...
  var r = new fe(e);
  return t !== Me && Va(r, t), n !== Me && ui(r, n), r;
}
function Eo(e, t) {
  return e === t;
}
...
function Ae(e, t, n) {
  return ct(e) ? e : Array.isArray(e) ? S.array(e, {
    ...
    name: n
  }) : typeof e == "function" && !Ue(e) && !lt(e) ? Tr(e) ? ze(e) : st(n, e) : e;
}
function No(e, t, n) {
...
function To(e, t, n, r) {
  ...
  if (lt(n.value))
    return 1;
  var o = zr(e, this, t, n, !1, !1);
  return Z(r, t, o), 2;
}
function Vo(e, t, n, r) {
  var i, o = zr(e, this, t, n, (i = this.options_) == null ? void 0 : i.bound);
...
var Xo = "observable", Zo = "observable.ref", Yo = "observable.shallow", Qo = "observable.struct", Hr = {
  deep: !0,
  name: void 0,
...
function ra(e) {
  var t;
  return e ? (t = e.defaultDecorator) != null ? t : Br(e) : void 0;
}
function ia(e) {
  var t, n;
...
var oa = {
  ...
  set: function(t, n) {
    var r = yt(n);
    return new bi(t, wt(r), r.name);
  },
  object: function(t, n, r) {
    return Te(function() {
      return hi(h.useProxies === !1 || r?.proxy === !1 ? qe({}, r) : Ha({}, r), t, n);
    });
  },
  ref: /* @__PURE__ */ Y(ea),
...
}, S = /* @__PURE__ */ Cr(Kr, oa), qr = "computed", aa = "computed.struct", gn = /* @__PURE__ */ Dn(qr), sa = /* @__PURE__ */ Dn(aa, {
...
var qn, Wn, Tt = 0, la = 1, ca = (qn = (Wn = /* @__PURE__ */ $t(function() {
}, "name")) == null ? void 0 : Wn.configurable) != null ? qn : !1, Gn = {
  value: "action",
  configurable: !0,
  writable: !1,
  enumerable: !1
...
function Se(e, t, n, r) {
  ...
  function i() {
    return Wr(e, n, t, r || this, arguments);
  }
  return i.isMobxAction = !0, i.toString = function() {
    return t.toString();
  }, ca && (Gn.value = e, Z(i, "name", Gn)), i;
}
...
var fa = "create", Ee = /* @__PURE__ */ function(e) {
  ...
  return t.onBecomeStale_ = function() {
    ...
    var i = Gt(!1), o;
    if (r)
      o = Gr(this, this.derivation, this.scope_);
...
function Gr(e, t, n) {
  var r = $n(!0);
  Xr(e), e.newObserving_ = new Array(
...
function ga(e) {
  ...
  for (n.length = i, e.newObserving_ = null, o = t.length; o--; ) {
    var s = t[o];
    s.diffValue === 0 && Zr(s, e), s.diffValue = 0;
  }
  for (; i--; ) {
    var c = n[i];
...
function Qr(e) {
  ...
  return t !== null ? (t.runId_ !== e.lastAccessedBy_ && (e.lastAccessedBy_ = t.runId_, t.newObserving_[t.unboundDepsCount_++] = e, !e.isBeingObserved && h.trackingContext && (e.isBeingObserved = !0, e.onBO())), e.isBeingObserved) : (e.observers_.size === 0 && h.inBatch > 0 && Yr(e), !1);
}
function ei(e) {
  e.lowestObserverState_ !== m.STALE_ && (e.lowestObserverState_ = m.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === m.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && t.isTracing_ !== U.NONE && ti(t, e), t.onBecomeStale_()), t.dependenciesState_ = m.STALE_;
  }));
}
function _a(e) {
  e.lowestObserverState_ !== m.STALE_ && (e.lowestObserverState_ = m.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === m.POSSIBLY_STALE_ ? (t.dependenciesState_ = m.STALE_, process.env.NODE_ENV !== "production" && t.isTracing_ !== U.NONE && ti(t, e)) : t.dependenciesState_ === m.UP_TO_DATE_ && (e.lowestObserverState_ = m.UP_TO_DATE_);
  }));
}
function ma(e) {
...
function ti(e, t) {
  if (console.log("[mobx.trace] '" + e.name_ + "' is invalidated due to a change in: '" + t.name_ + "'"), e.isTracing_ === U.BREAK) {
    var n = [];
    ni(ja(e), n, 1), new Function(`debugger;
/*
Tracing '` + e.name_ + `'
...
var ee = /* @__PURE__ */ function() {
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.isScheduled || (this.isScheduled = !0, h.pendingReactions.push(this), ri());
...
function Ea() {
  ...
  for (var e = h.pendingReactions, t = 0; e.length > 0; ) {
    ++t === Jn && (console.error(process.env.NODE_ENV !== "production" ? "Reaction doesn't converge to a stable state after " + Jn + " iterations." + (" Probably there is a cycle in the reactive function: " + e[0]) : "[mobx] cycle in reaction: " + e[0]), e.splice(0));
...
var Cn = "action", Sa = "action.bound", ii = "autoAction", Na = "autoAction.bound", oi = "<unnamed action>", mn = /* @__PURE__ */ gt(Cn), xa = /* @__PURE__ */ gt(Sa, {
  bound: !0
}), yn = /* @__PURE__ */ gt(ii, {
  autoAction: !0
}), Pa = /* @__PURE__ */ gt(Na, {
...
var ye = /* @__PURE__ */ ai(!1);
Object.assign(ye, mn);
var st = /* @__PURE__ */ ai(!0);
Object.assign(st, yn);
ye.bound = /* @__PURE__ */ Y(xa);
st.bound = /* @__PURE__ */ Y(Pa);
function Da(e) {
  return Wr(e.name || oi, !1, e, this, void 0);
}
function Ue(e) {
...
function ci(e, t, n) {
  ...
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction", l = ye(a, n.onError ? Ca(n.onError, t) : t), s = !n.scheduler && !n.delay, c = li(n), u = !0, d = !1, v, g = n.compareStructural ? Ie.structural : n.equals || Ie.default, _ = new ee(a, function() {
    u || s ? w() : d || (d = !0, c(w));
...
function fi(e) {
  ...
  return e.observing_ && e.observing_.length > 0 && (t.dependencies = Ra(e.observing_).map(fi)), t;
}
function Ra(e) {
...
var an = /* @__PURE__ */ Ur("flow"), La = /* @__PURE__ */ Ur("flow.bound", {
  bound: !0
  ...
  var r = t, i = r.name || "<unnamed flow>", o = function() {
    var l = this, s = arguments, c = ++Ma, u = ye(i + " - runid: " + c + " - init", r).apply(l, s), d, v = void 0, g = new Promise(function(_, w) {
      var N = 0;
      d = w;
      function G($) {
        v = void 0;
...
function Ha(e, t) {
  var n, r;
  return kr(), e = qe(e, t), (r = (n = e[p]).proxy_) != null ? r : n.proxy_ = new Proxy(e, Ba);
}
function R(e) {
...
function Zt(e, t, n) {
  return process.env.NODE_ENV !== "production" && (!D(e) && !D(Object.getPrototypeOf(e)) && f("'makeAutoObservable' can only be used for classes that don't have a superclass"), We(e) && f("makeAutoObservable can only be used on objects not already made observable")), D(e) ? hi(e, e, t, n) : (Te(function() {
    var r = qe(e, n)[p];
    if (!e[sn]) {
...
var Zn = "splice", H = "update", Fa = 1e4, Ka = {
  get: function(t, n) {
    var r = t[p];
  ...
  return t.dehanceValue_ = function(r) {
    ...
    r !== this.lastKnownLength_ && f(16), this.lastKnownLength_ += i, this.legacyMode_ && i > 0 && yi(r + i + 1);
...
function qa(e, t, n, r) {
  return n === void 0 && (n = process.env.NODE_ENV !== "production" ? "ObservableArray@" + B() : "ObservableArray"), r === void 0 && (r = !1), kr(), Te(function() {
...
var Ga = {}, ce = "add", Mt = "delete", gi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    var o = this;
    r === void 0 && (r = Ae), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableMap@" + B() : "ObservableMap"), this.enhancer_ = void 0, this.name_ = void 0, this[p] = Ga, this.data_ = void 0, this.hasMap_ = void 0, this.keysAtom_ = void 0, this.interceptors_ = void 0, this.changeListeners_ = void 0, this.dehancer = void 0, this.enhancer_ = r, this.name_ = i, A(Map) || f(18), Te(function() {
      o.keysAtom_ = Lr(process.env.NODE_ENV !== "production" ? o.name_ + ".keys()" : "ObservableMap.keys()"), o.data_ = /* @__PURE__ */ new Map(), o.hasMap_ = /* @__PURE__ */ new Map(), n && o.merge(n);
    });
  }
  var t = e.prototype;
  return t.has_ = function(r) {
    ...
    if (!o) {
      ...
      this.hasMap_.set(r, a), ui(a, function() {
    ...
    X(this.keysAtom_), re(function() {
      var c, u = new Ee(i, o.enhancer_, process.env.NODE_ENV !== "production" ? o.name_ + "." + fn(r) : "ObservableMap.key", !1);
    ...
    return re(function() {
      ...
      if (!l)
        if (i.data_.size !== a.size)
          ...
          for (var $ = i.data_.keys(), ae = a.keys(), pe = $.next(), Fn = ae.next(); !pe.done; ) {
            if (pe.value !== Fn.value) {
              i.keysAtom_.reportChanged();
              break;
            }
            pe = $.next(), Fn = ae.next();
...
}(), ve = /* @__PURE__ */ Ce("ObservableMap", gi);
function Yn(e) {
...
var Xa = {}, bi = /* @__PURE__ */ function() {
  function e(n, r, i) {
    ...
    r === void 0 && (r = Ae), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + B() : "ObservableSet"), this.name_ = void 0, this[p] = Xa, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, A(Set) || f(22), this.enhancer_ = function(a, l) {
      ...
      o.atom_ = Lr(o.name_), n && o.replace(n);
    });
  }
  var t = e.prototype;
  return t.dehanceValue_ = function(r) {
...
var er = /* @__PURE__ */ Object.create(null), tr = "remove", wn = /* @__PURE__ */ function() {
  ...
  return t.getObservablePropValue_ = function(r) {
    ...
    if (i === !0 && (i = this.defaultAnnotation_), i !== !1) {
      if (ir(this, i, r), !(r in this.target_)) {
        var o;
    ...
    try {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[r], c && (this.values_.delete(r), c instanceof Ee && (u = c.value_), ei(c)), this.keysAtom_.reportChanged(), (a = this.pendingKeys_) == null || (a = a.get(r)) == null || a.set(r in this.target_), l || s) {
        var v = {
          type: tr,
          observableKind: "object",
          object: this.proxy_ || this.target_,
...
function qe(e, t) {
  ...
  if (process.env.NODE_ENV !== "production" && t && We(e) && f("Options can't be provided for already observable objects."), F(e, p))
    return process.env.NODE_ENV !== "production" && !(wi(e) instanceof wn) && f("Cannot convert '" + Lt(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
  ...
  var r = (n = t?.name) != null ? n : process.env.NODE_ENV !== "production" ? (D(e) ? "ObservableObject" : e.constructor.name) + "@" + B() : "ObservableObject", i = new wn(e, /* @__PURE__ */ new Map(), String(r), ra(t));
  return Ht(e, p, i), e;
}
...
function ir(e, t, n) {
  if (process.env.NODE_ENV !== "production" && !Ei(t) && f("Cannot annotate '" + e.name_ + "." + n.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !kt(t) && F(e.appliedAnnotations_, n)) {
...
var Ya = /* @__PURE__ */ mi(0), Qa = /* @__PURE__ */ function() {
  var e = !1, t = {};
...
var Tn = /* @__PURE__ */ function(e) {
  function t(r, i, o, a) {
    ...
    return o === void 0 && (o = process.env.NODE_ENV !== "production" ? "ObservableArray@" + B() : "ObservableArray"), a === void 0 && (a = !1), l = e.call(this) || this, Te(function() {
      ...
      s.proxy_ = l, Vr(l, p, s), r && r.length && l.spliceWithArray(0, 0, r), Qa && Object.defineProperty(l, "0", Ya);
    }), l;
  }
  Mr(t, e);
  var n = t.prototype;
...
var sr, rs = ((sr = Sn().Iterator) == null ? void 0 : sr.prototype) || {};
function jn(e) {
...
const xe = "copilot-", as = "24.5.1", Ul = "attention-required", zl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Bl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Hl = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, ss = (e) => {
  const t = [];
  let n = cs(e);
  for (; n; )
...
var Oi = /* @__PURE__ */ ((e) => (e["vaadin-combo-box"] = "vaadin-combo-box", e["vaadin-date-picker"] = "vaadin-date-picker", e["vaadin-dialog"] = "vaadin-dialog", e["vaadin-multi-select-combo-box"] = "vaadin-multi-select-combo-box", e["vaadin-select"] = "vaadin-select", e["vaadin-time-picker"] = "vaadin-time-picker", e["vaadin-popover"] = "vaadin-popover", e))(Oi || {});
const Xe = {
  "vaadin-combo-box": {
    hideOnActivation: !0,
    open: (e) => Et(e),
  ...
  "vaadin-select": {
    ...
    open: (e) => {
      const t = e;
      Si(t, t._overlayElement), t.opened = !0;
    },
    close: (e) => {
      const t = e;
      Ni(t, t._overlayElement), t.opened = !1;
    }
  },
  ...
  e.addEventListener("focusout", Ai, { capture: !0 }), Si(e), e.opened = !0;
}, Ot = (e) => {
  Ni(e), e.removeAttribute("focused"), e.removeEventListener("focusout", Ai, { capture: !0 }), e.opened = !1;
}, Si = (e, t) => {
  const n = t ?? e.$.overlay;
...
class us {
  ...
  overlayStatus(t) {
    if (!t)
      return { visible: !1 };
    const n = t.localName;
    let r = Object.keys(Oi).includes(n);
    if (!r)
      return { visible: !1 };
...
function Pe(e, t) {
  Rn().then((n) => n.send(e, { ...t, context: fs }));
}
async function Jl() {
  return await Rn(), !!window.Vaadin.devTools.conf.backend;
}
class vs {
  constructor() {
  ...
  constructor() {
    this.dismissedNotifications = [], this.termsSummaryDismissed = !1, this.activationButtonPosition = null, this.paletteState = null, this.activationShortcut = !0, this.activationAnimation = !0, Zt(this), this.initializer = new vs(), this.initializer.promise.then(() => {
      ci(
        () => JSON.stringify(this),
        () => {
          Pe("copilot-set-machine-configuration", { conf: JSON.stringify(cr(this)) });
        }
      );
    }), window.Vaadin.copilot.eventbus.on("copilot-machine-configuration", (t) => {
      const n = t.detail.conf;
      Object.assign(this, cr(n)), this.initializer.done(!0), t.preventDefault();
    }), this.loadData();
  }
  loadData() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const xt = globalThis, Mn = xt.ShadowRoot && (xt.ShadyCSS === void 0 || xt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ln = Symbol(), ur = /* @__PURE__ */ new WeakMap();
let $i = class {
  constructor(t, n, r) {
    if (this._$cssResult$ = !0, r !== Ln) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const le = (e) => new $i(typeof e == "string" ? e : e + "", void 0, Ln), ms = (e, ...t) => {
...
}, dr = Mn ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let n = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ws, defineProperty: Es, getOwnPropertyDescriptor: Os, getOwnPropertyNames: As, getOwnPropertySymbols: Ss, getPrototypeOf: Ns } = Object, Qt = globalThis, hr = Qt.trustedTypes, xs = hr ? hr.emptyScript : "", Ps = Qt.reactiveElementPolyfillSupport, rt = (e, t) => e, On = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? xs : null;
      break;
  ...
  return n;
} }, Ci = (e, t) => !ws(e, t), fr = { attribute: !0, type: String, converter: On, reflect: !1, hasChanged: Ci };
...
class Re extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const i of r) n.unshift(dr(i));
    } else t !== void 0 && n.push(dr(t));
    return n;
  }
  static _$Eu(t, n) {
    const r = n.attribute;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const In = globalThis, It = In.trustedTypes, pr = It ? It.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Un = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, zn = "?" + ie, Cs = `<${zn}>`, De = document, dt = () => De.createComment(""), ht = (e) => e === null || typeof e != "object" && typeof e != "function", Bn = Array.isArray, ki = (e) => Bn(e) || typeof e?.[Symbol.iterator] == "function", cn = `[ 	
\f\r]`, Ze = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, gr = /-->/g, br = />/g, be = RegExp(`>|${cn}(?:([^\\s"'>=/]+)(${cn}*=${cn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), _r = /'/g, mr = /"/g, Ti = /^(?:script|style|textarea|title)$/i, Vi = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), Ut = Vi(1), Yl = Vi(2), he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), yr = /* @__PURE__ */ new WeakMap(), we = De.createTreeWalker(De, 129);
function ji(e, t) {
...
const Ri = (e, t) => {
  ...
  for (let l = 0; l < n; l++) {
    const s = e[l];
    let c, u, d = -1, v = 0;
    for (; v < s.length && (a.lastIndex = v, u = a.exec(s), u !== null); ) v = a.lastIndex, a === Ze ? u[1] === "!--" ? a = gr : u[1] !== void 0 ? a = br : u[2] !== void 0 ? (Ti.test(u[2]) && (i = RegExp("</" + u[2], "g")), a = be) : u[3] !== void 0 && (a = be) : a === be ? u[0] === ">" ? (a = i ?? Ze, d = -1) : u[1] === void 0 ? d = -2 : (d = a.lastIndex - u[2].length, c = u[1], a = u[3] === void 0 ? be : u[3] === '"' ? mr : _r) : a === mr || a === _r ? a = be : a === gr || a === br ? a = Ze : (a = be, i = void 0);
    const g = a === be && e[l + 1].startsWith("/>") ? " " : "";
    o += a === Ze ? s + Cs : d >= 0 ? (r.push(c), s.slice(0, d) + Un + s.slice(d) + ie + g) : s + ie + (d === -2 ? l : g);
  }
...
class ft {
  constructor({ strings: t, _$litType$: n }, r) {
    ...
    for (; (i = we.nextNode()) !== null && s.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith(Un)) {
          const v = u[a++], g = i.getAttribute(d).split(ie), _ = /([.?@])?(.*)/.exec(v);
          s.push({ type: 1, index: o, name: _[2], strings: g, ctor: _[1] === "." ? Ii : _[1] === "?" ? Ui : _[1] === "@" ? zi : mt }), i.removeAttribute(d);
      ...
      } else if (i.nodeType === 8) if (i.data === zn) s.push({ type: 2, index: o });
      else {
        let d = -1;
...
let en = class Li {
  ...
  _$AC(t) {
    let n = yr.get(t.strings);
    return n === void 0 && yr.set(t.strings, n = new ft(t)), n;
  }
  k(t) {
...
const ks = { M: Un, P: ie, A: zn, C: 1, L: Ri, R: Mi, D: ki, V: $e, I: en, H: mt, N: Ui, U: zi, B: Ii, F: Bi }, Ts = In.litHtmlPolyfillSupport;
...
function Ls() {
  me.push(import("./copilot-log-plugin-X6FukerG.js")), me.push(import("./copilot-info-plugin-BKPvI0q5.js")), me.push(import("./copilot-features-plugin-DPkGrTKg.js")), me.push(import("./copilot-feedback-plugin-COWOFXLw.js")), me.push(import("./copilot-shortcuts-plugin-XHTp_6pb.js"));
}
function Is() {
  {
...
function Us() {
  Promise.all(me).then(() => {
    ...
    if (e.copilot.plugins) {
      ...
      e.copilot.plugins.push = (n) => Er(n), Array.from(t).forEach((n) => {
        wr.includes(n) || (Er(n), wr.push(n));
      });
    }
  }), me = [];
}
...
const Ye = window.Vaadin.copilot.overlayManager, ec = {
...
const Bs = Fi(An);
function qi() {
  return import("./copilot-notification-uGUDnAiD.js");
}
const Hs = (e) => {
...
}, Js = async () => Di(`${xe}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Xs = async () => Pi(() => b.userInfo), ic = async () => (await Xs()).vaadiner;
...
}, rl = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, se = Qs(), oc = {
...
const eo = Symbol.for(""), il = (e) => {
...
}, to = (e) => ({ _$litStatic$: e, r: eo }), Sr = /* @__PURE__ */ new Map(), ol = (e) => (t, ...n) => {
  const r = n.length;
  let i, o;
  const a = [], l = [];
  let s, c = 0, u = !1;
  ...
  if (c === r && a.push(t[r]), u) {
    const d = a.join("$$lit$$");
    (t = Sr.get(d)) === void 0 && (a.raw = a, Sr.set(d, t = a)), n = l;
  }
  return e(t, ...n);
}, ot = ol(Ut);
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: al } = ks, Nr = () => document.createComment(""), et = (e, t, n) => {
  const r = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
  if (n === void 0) {
    const o = r.insertBefore(Nr(), i), a = r.insertBefore(Nr(), i);
...
const xr = (e, t, n) => {
  ...
  update(e, [t, n, r]) {
    ...
    else if (c === void 0 && (c = xr(a, g, _), u = xr(l, d, v)), c.has(l[d])) if (c.has(l[v])) {
...
const Dr = new Dl(), $l = "copilot-development-setup-user-guide";
function Cl() {
...
let $r = class extends Ms {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, document.body.style.setProperty("--dev-tools-button-display", "none"), await import("./copilot-global-vars-later-BdIPjlDu.js"), await import("./copilot-init-step2-BCSbCnWi.js"), Ls(), this.tabIndex = 0, At.hostConnectedCallback(), window.addEventListener("keydown", Ar), E.onSend(this.handleSendEvent), this.removers.push(E.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), ue.getCopilotActivation() && Rn().then(() => {
   ...
   */
  activate() {
    tn("activate"), At.activate(), Dr.copilotActivated(), Us(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), Ye.onCopilotActivation(), E.emit("component-tree-updated", {}), Zi.loadPreviewConfiguration();
  }
  /**
   * Called when Copilot is deactivated. Good place to remove listeners etc.
   */
  deactivate() {
    this.closeDrawers(), At.deactivate(), Dr.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), Ye.onCopilotDeactivation();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), At.hostDisconnectedCallback(), window.removeEventListener("keydown", Ar), E.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.mouseMoveListener), Ye.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener);
  }
  handleSendEvent(e) {
