import { n as I, M as $, b as u, j as r, o as T, p as d, q as oe, r as O, u as L, O as F, A as x, v as m, x as l, w as pe, y as ue, z as N, B as G, E as p, D as ge, k as ve, l as fe, P as me, F as be, I as we, V as ye, G as xe, H as ne, J as S, K as B, L as se, N as W, Q as Pe, R as Ie, S as ze, T as Ae, U as ae, W as Ce, X as ke, Y as Se, Z as $e, _ as re, $ as le, a0 as De } from "./copilot-B9Ps-PeT.js";
import { n as j, r as z } from "./state-BNLduNe4.js";
import { e as A, m as de } from "./overlay-monkeypatch-Pq3ntiKU.js";
import { i as h } from "./icons-TTziXZQT.js";
/**
 * @license
...
var Me = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, C = (e, t, o, n) => {
...
let y = class extends $ {
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      (t) => {
        t === F.DragAndDrop && !this.opened && !this.keepOpen ? this.style.setProperty("pointer-events", "none") : this.style.setProperty("pointer-events", "auto");
      }
    ), this.reaction(
...
var Re = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, ce = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? Oe(t, o) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, o, i) : a(i)) || i);
  return n && i && Re(t, o, i), i;
};
...
class je {
  ...
  dragging(t, o) {
    const n = o.clientX, i = o.clientY, s = n - this.offsetX, a = n - this.offsetX + t.getBoundingClientRect().width, c = i - this.offsetY, g = i - this.offsetY + t.getBoundingClientRect().height;
    return this.adjust(t, s, c, a, g);
  }
  adjust(t, o, n, i, s) {
    let a, c, g, k;
    const E = document.documentElement.getBoundingClientRect().width, U = document.documentElement.getBoundingClientRect().height;
    return (i + o) / 2 < E / 2 ? (t.style.setProperty("--left", `${o}px`), t.style.setProperty("--right", ""), k = void 0, a = Math.max(0, o)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${E - i}px`), a = void 0, k = Math.max(0, E - i)), (n + s) / 2 < U / 2 ? (t.style.setProperty("--top", `${n}px`), t.style.setProperty("--bottom", ""), g = void 0, c = Math.max(0, n)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${U - s}px`), c = void 0, g = Math.max(0, U - s)), {
      left: a,
      right: k,
      top: c,
      bottom: g
...
const w = new je();
var Te = Object.defineProperty, Be = Object.getOwnPropertyDescriptor, M = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? Be(t, o) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, o, i) : a(i)) || i);
...
function He(e, t) {
  if (!t)
    return !0;
  const [o, n, i] = t.split(".").map((g) => parseInt(g)), [s, a, c] = e.split(".").map((g) => parseInt(g));
  if (o < s)
    return !0;
  if (o == s) {
    if (n < a)
...
let b = class extends $ {
  ...
  renderPluginSection(e) {
    ...
    const i = e.idePluginInstalled ? h.successColorful : h.warningColorful;
    return l`
      <details
        part="panel"
  ...
  renderHotswapSection(e) {
    ...
    const o = N(), n = ge();
    let i, s, a;
    return o === "success" ? (i = h.successColorful, a = "Java Hotswap is enabled") : o === "warning" ? (i = h.warningColorful, a = "Java Hotswap is not enabled") : o === "error" && (i = h.warningColorful, a = "Java Hotswap is partially enabled"), this.hotswapTab === "jrebel" ? t.jrebel ? s = this.renderJRebelInstalledContent() : s = this.renderJRebelNotInstalledContent() : e.intellij ? s = this.renderHotswapAgentIntelliJPluginContent() : s = this.renderHotswapAgentNotInstalledContent(e), l` <details
      part="panel"
  ...
  renderJRebelNotInstalledContent() {
    return l`
      <div>
        <a href="https://www.jrebel.com">JRebel ${h.linkExternal}</a> is a commercial hotswap solution. Vaadin
        ...
        <p>
          ...
          <a href="https://www.jrebel.com/products/jrebel/learn" target="_blank" rel="noopener noreferrer">
            https://www.jrebel.com/products/jrebel/learn ${h.linkExternal}</a
          >
          to get started
        </p>
      </div>
      ...
      <div part="hotswap-agent-section-container">
        <div class="inner-section">
          <details class="inner" .open="${!t}">
            <summary>
              <span class="icon">${t ? h.successColorful : h.warningColorful}</span>
    ...
    return l`
      <div class="inner-section">
        <details class="inner" .open="${!e}">
          <summary>
            <span class="icon">${e ? h.successColorful : h.warningColorful}</span>
      ...
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && He("1.3.0", r.idePluginState?.version) ? l` <li>Upgrade to the latest IntelliJ plugin</li>` : p}
...
d.addPanel(Y);
var Ne = Object.defineProperty, Je = Object.getOwnPropertyDescriptor, Ve = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? Je(t, o) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, o, i) : a(i)) || i);
  return n && i && Ne(t, o, i), i;
};
let Q = class extends $ {
  constructor() {
  ...
  render() {
    const e = ne(), t = e.status === "warning" || e.status === "error";
    return l`
...
var qe = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, Xe = (e, t, o, n) => {
...
let ee = class extends $ {
  ...
  renderDot() {
    return r.userInfo?.validLicense ? p : S.active || S.expired ? l`<div class="icon warning"></div>` : p;
  }
};
ee = Xe([
  I("copilot-activation-button-user-info")
], ee);
var Ye = Object.defineProperty, Ge = Object.getOwnPropertyDescriptor, H = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? Ge(t, o) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, o, i) : a(i)) || i);
  return n && i && Ye(t, o, i), i;
};
const We = 8;
let _ = class extends $ {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: o } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(o - this.initialMouseDownPosition.y) > We;
      }
      ...
      const o = document.querySelector("copilot-main")?.shadowRoot?.querySelector("vaadin-menu-bar-overlay.activation-button-menu"), n = this.menubar;
      if (!o)
        return !1;
      const i = o.querySelector("vaadin-menu-bar-list-box");
      if (!i)
        return !1;
      const s = i.getBoundingClientRect(), a = n.getBoundingClientRect(), c = Math.min(s.x, a.x), g = Math.min(s.y, a.y), k = Math.max(s.width, a.width), E = s.height + a.height;
      return oe(new DOMRect(c, g, k, E), e.clientX, e.clientY);
  ...
  firstUpdated() {
    this.setMenuBarOnClick(), de(this.shadowRoot);
  }
};
H([
  A("vaadin-menu-bar")
...
var Ke = Object.defineProperty, Ze = Object.getOwnPropertyDescriptor, D = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? Ze(t, o) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, o, i) : a(i)) || i);
  return n && i && Ke(t, o, i), i;
};
const v = "resize-dir", V = "floating-resizing-active";
let P = class extends $ {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      let c = "";
      o < a ? i < a ? (c = "nw-resize", this.setAttribute(v, "top left")) : s < a ? (c = "sw-resize", this.setAttribute(v, "bottom left")) : (c = "col-resize", this.setAttribute(v, "left")) : n < a ? i < a ? (c = "ne-resize", this.setAttribute(v, "top right")) : s < a ? (c = "se-resize", this.setAttribute(v, "bottom right")) : (c = "col-resize", this.setAttribute(v, "right")) : s < a ? (c = "row-resize", this.setAttribute(v, "bottom")) : i < a && (c = "row-resize", this.setAttribute(v, "top")), c !== "" ? (this.rectangleBeforeResizing = this.getBoundingClientRect(), this.style.setProperty("--resize-cursor", c)) : (this.style.removeProperty("--resize-cursor"), this.removeAttribute(v)), this.toggleAttribute(V, c !== "");
      ...
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(V), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(v)));
      ...
      if (i.includes("top")) {
        const a = Math.max(0, n), c = s.top - a + s.height;
        this.setFloatingResizeDirectionProps("top", a, void 0, c);
      }
      if (i.includes("bottom")) {
        const a = Math.max(0, n), c = a - s.bottom + s.height;
        this.setFloatingResizeDirectionProps("bottom", a, void 0, c);
      }
      ...
      const { width: t, height: o } = this.getBoundingClientRect(), { left: n, top: i, bottom: s, right: a } = w.anchor(this), c = window.getComputedStyle(this.container), g = Number.parseInt(c.borderTopWidth, 10), k = Number.parseInt(c.borderTopWidth, 10);
      ...
      e.button === 0 && (d.bringToFront(this.panelInfo.tag), !this.hasAttribute(v) && (e.target instanceof HTMLButtonElement && e.target.getAttribute("part") === "title-button" ? this.startDraggingDebounce(e) : this.startDragging(e)));
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            r.operationInProgress === F.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
      ...
      <div part="container">
        <div part="header" class="drag-handle">
          ${this.panelInfo.expandable !== !1 ? l` <button
                ...
                ${this.panelInfo.expanded ? h.chevronDown : h.chevronRight}
              </button>` : p}
  ...
  getPopupButtonIcon() {
    return this.panelInfo ? this.panelInfo.panel === void 0 ? h.close : this.panelInfo.floating ? this.panelInfo.panel === "bottom" ? h.dockBottom : this.panelInfo.panel === "left" ? h.dockLeft : this.panelInfo.panel === "right" ? h.dockRight : p : h.popup : p;
  }
  renderHelpButton() {
...
u.on("undoRedo", (e) => {
  const o = { files: e.detail.files ?? ze(), uiId: Ae() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", i = e.detail.undo ? "undo" : "redo";
  ae(i), Qe(F.RedoUndo), u.send(n, o);
});
var et = Object.defineProperty, tt = Object.getOwnPropertyDescriptor, it = (e, t, o, n) => {
  for (var i = n > 1 ? void 0 : n ? tt(t, o) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, o, i) : a(i)) || i);
...
ie ? ie.add((e, t) => {
  e === "loading" && t === "connected" && r.active && he();
}) : console.warn("Unable to add listener for connection state changes");
u.on("copilot-plugin-state", (e) => {
  r.setIdePluginState(e.detail), e.detail.active && ae("plugin-active", { pluginVersion: e.detail.version, ide: e.detail.ide }), e.preventDefault();
});
u.on("copilot-ide-notification", (e) => {
  re({
    type: le[e.detail.type],
